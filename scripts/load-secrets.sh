...
case "$ENV" in
  ...
  prod|production)
    ...
    SECRETS=(API_KEY SLACK_BOT_TOKEN SLACK_APP_TOKEN LINEAR_API_KEY GITHUB_TOKEN ANTHROPIC_API_KEY GITHUB_WEBHOOK_SECRET LINEAR_WEBHOOK_SECRET WORKER_URL SENTRY_DSN NOTION_TOKEN CONTEXT7_TOKEN SENTRY_TOKEN CLOUDFLARE_READ_TOKEN BIKE_TOOL_GITHUB_TOKEN HEALTH_TOOL_GITHUB_TOKEN PRODUCT_ENGINEER_GITHUB_TOKEN FRYANPAN_ORG_GITHUB_TOKEN PERSONAL_CRM_GITHUB_TOKEN)
    ;;
  *)
